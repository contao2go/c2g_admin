                    ...
                    if(is_file(TL_ROOT.'/backups/'.$hosts))
                    {
                        ...
                        if(($c2gFile->extension=='c2g')&&($c2gFile->filesize>0))
                        {
                            ...
                            if($descFile)
                            {
                                ...
                                {
                                    $desc=sprintf('%s : <div class="block">%s</div><br />', $GLOBALS['TL_LANG']['tl_content']['c2g_backupdescription'], $GLOBALS["package"]["Description"]);
                                }

                                $arrOutput['header']=sprintf('%s', htmlspecialchars_decode($desc));
                                $arrOutput['description']=sprintf('%s : <i>%s</i><br />%s : <i>%s</i>', $GLOBALS['TL_LANG']['tl_content']['c2g_backupcreate'], $this->parseDate($GLOBALS['TL_CONFIG']['datimFormat'], $GLOBALS["package"]["Time"]), $GLOBALS['TL_LANG']['tl_content']['c2g_backupsize'], $this->getReadableSize($c2gFile->filesize));
                                ...
                                if(!$GLOBALS['TL_CONFIG']['c2g_disablesnapshoting'])
                                {
                                    $arrOutput['buttons'][]=sprintf('
										...
										</a>', $requestLink, $GLOBALS['TL_LANG']['tl_content']['c2g_deletepackage'], sprintf($GLOBALS['TL_LANG']['tl_content']['c2g_deletepackage_confirm'], $GLOBALS["package"]["Name"]), $GLOBALS['TL_LANG']['tl_content']['c2g_pleasewait']);
                                }
                                ...
                                $arrOutput['buttons'][]=sprintf('
									...
									</a>', $this->Environment->request, $hosts, $GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage'], sprintf($GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_confirm'], $GLOBALS["package"]["Name"]), $GLOBALS['TL_LANG']['tl_content']['c2g_pleasewait']);
                                ...
                                $strRestoreOutput=sprintf('<li>
									<a href="%s?file=%s&amp;act=restore_db" title="%s" onclick="if (!confirm(\'%s\')) return false; else AjaxRequest.displayBox(\'%s\');">
										%s
									</a></li>', $this->Environment->request, $hosts, $GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_db'], sprintf($GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_confirm'], $GLOBALS["package"]["Name"]), $GLOBALS['TL_LANG']['tl_content']['c2g_pleasewait'], $GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_db']);

                                $strRestoreOutput.=sprintf('<li>
									<a href="%s?file=%s&amp;act=restore_files" title="%s" onclick="if (!confirm(\'%s\')) return false;n else AjaxRequest.displayBox(\'%s\');">
										%s
									</a></li>', $this->Environment->request, $hosts, $GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_files'], sprintf($GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_confirm'], $GLOBALS["package"]["Name"]), $GLOBALS['TL_LANG']['tl_content']['c2g_pleasewait'], $GLOBALS['TL_LANG']['tl_content']['c2g_restorepackage_files']);
                                ...
                                if(!$GLOBALS['TL_CONFIG']['c2g_disablesnapshoting'])
                                {
                                    $arrOutput['buttons'][]=sprintf('
										...
										</a>', $hosts, $GLOBALS['TL_LANG']['tl_content']['c2g_downloadpackage']);
                                }
        ...
        if($restoreFile)
        {
            ...
            if($c2gFile->extension=='c2g')
            {
                ...
                if($descFile)
                {
                    ...
                    $arrConfigReturn=$this->c2g_functions->loadVHostConfig(TL_ROOT.'/vhosts/'.$GLOBALS["package"]["Name"],true);
